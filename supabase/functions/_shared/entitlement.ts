...
import { extenderAcesso } from "./acesso.ts";
...
export type GrantProOpts = {
  ...
  /** false = não soma período (mesmo pagamento já liberado). */
  extendUntil?: boolean;
};
...
export async function grantProAccess(admin: SupabaseClient, opts: GrantProOpts) {
